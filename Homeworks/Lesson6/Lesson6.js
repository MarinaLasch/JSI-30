...
class Student extends User { 
  constructor(name, surname, year) { 
   ...
   getCourse () { 
      let course = new Date() 
      return course.getFullYear() - this.year; 
  } 
} 
...
console.log(student.getCourse()); //выведет 4 - курс, так как текущий год 2023
///////////////////////////////////////////////
...
// Hamster.prototype.food = [ ]; - убираем т.к в этом случае массив food изменяется в прототипе,
// т к для экземпляров speedy и lazy он  общий. Мы добавляем this.food в класс объекта, который будет наследоваться не напрямую, а создаваться отдельно для каждого экземпляра класса.
; // пустой ""живот""
